...
export const LabOutsource = () => {
    ...
    return (
        <div>
            <h4 style={{ backgroundColor: '#dae1f3' }} className='p-4 fw-bold mb-4'>Outsource Management</h4>
            <Container>
                <div className="row">
                    ...
                    <table className="table table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td className="col-md-3">Pathology</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td className="col-md-3"> #21445</td>
                            </tr>
                            <tr>
