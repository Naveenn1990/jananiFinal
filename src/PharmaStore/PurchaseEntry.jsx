...
export const PurchaseEntry = () => {
    ...
    return (
        <div>
            <h4 style={{ backgroundColor: '#dae1f3' }} className='p-4 fw-bold mb-4'>Purchase Entry</h4>
                    ...
                    <div className="col-lg-7 p-0" >
                        <Container>
                            ...
                            <div className="row mb-5 ">
                                ...
                                <Button style={{marginTop:'35px'}} className='green-btn-4 col-md-4  align-items-center' onClick={() => navigate('#')}></Button>
