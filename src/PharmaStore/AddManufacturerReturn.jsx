...
export const AddManufacturerReturn = () => {
...
const navigate = useNavigate()
    ...
    return (
        <div>
            ...
            <h3 style={{ backgroundColor: '#dae1f3' }} className='p-4 fw-bold mb-4'>Add Manufacturer Return</h3>

            <Container >
                <div className="row ms-3">
                    <div class="mb-4 col-lg-4 ">
                        <FormLabel className='fw-bold text-dark'>Company* </FormLabel>
                        <input style={{ width: '300px' }} type="text" class="form-control" placeholder="Company Name" aria-describedby="basic-addon1" />
                    </div>

                    <div class="mb-4 col-lg-4 ">
                        <FormLabel className='fw-bold text-dark'>Phone* </FormLabel>
                        <input style={{ width: '300px' }} type="number" class="form-control" placeholder="Phone Name" aria-describedby="basic-addon1" />
                    </div>
                ...
                <div className="row ms-3">
                    ...
                    <div className='mb-4 col-lg-4' >
                        ...
                        <Form.Select style={{ width: '300px' }} aria-label="Default select example">
                            ...
                            <option value="3">Damage Drug</option>
                ...
                <FormLabel className='fw-bold text-dark'>Description* </FormLabel>
                    ...
                    <Button className='mb-4 all-bg-green' onClick={() => navigate('/manufacturerreturn')}> Add Return</Button>
