...
export const WastageReturn = () => {
    ...
    return (
        <div>
            <h4 style={{ backgroundColor: '#dae1f3' }} className='p-4 fw-bold mb-4'>Wastage Return List</h4>
            ...
            <Container>
                <div className="row">
                    ...
                    <div className="col-lg-9  d-flex gap-2 ">
                        ...
                        <Button className='green-btn-7' onClick={() => navigate('/addwastagereturn')}>
                    ...
                    <table className='table  '>
                        <thead>
                            <tr className="admin-table-head" >
                                ...
                                <th className="fw-bold" style={{ width: '176px' }}>Reason</th>
                        ...
                        <tbody >
                            <tr className="admin-table-row" >
                                ...
                                <td><span className='text-dark fw-bold'>Ganesh Kalal</span> <br /><span style={{ fontSize: '12px', color: 'grey' }}>info@softnio.com</span> </td>
                                <td>19/12/2020 </td>


                                <td>
                                    <div className="Diseases-btn" style={{ color: 'red', border: '1px solid red' }}>Wrong Medication</div>
                                </td>
                            ...
                            <tr className="admin-table-row" >
                                ...
                                <td><span className='text-dark fw-bold'>Amandeep Singh</span> <br /><span style={{ fontSize: '12px', color: 'grey' }}>info@softnio.com</span> </td>
                                <td>19/12/2020 </td>

                                <td>
                                    <div className="Diseases-btn" style={{ color: 'orange', border: '1px solid orange' }}>Wrong dispensing</div>
                                </td>
        ...
        <Dropdown.Item className='medicine-list-dropdown' href="/medicinedetail"><FontAwesomeIcon icon={faEye} className='me-2' />View Details</Dropdown.Item> */}
                            ...
                            <tr className="admin-table-row" >
                                ...
                                <td><span className='text-dark fw-bold'>Sheetal parnet</span> <br /><span style={{ fontSize: '12px', color: 'grey' }}>info@softnio.com</span> </td>
                                <td>17/05/2021</td>
        ...
        <Dropdown.Item className='medicine-list-dropdown' href="/medicinedetail"><FontAwesomeIcon icon={faEye} className='me-2' />View Details</Dropdown.Item> */}
                            ...
                            <tr className="admin-table-row" >
                                ...
                                <td><span className='text-dark fw-bold'>Sunny</span> <br /><span style={{ fontSize: '12px', color: 'grey' }}>info@softnio.com</span> </td>
                                <td>05/12/2021 </td>

                                <td>
                                    <div className="Diseases-btn" style={{ color: 'blue', border: '1px solid blue' }}>Subsidence symptoms</div>
                                </td>
...
<Dropdown.Item className='medicine-list-dropdown' href="/medicinedetail"><FontAwesomeIcon icon={faEye} className='me-2' />View Details</Dropdown.Item> */}
                            ...
                            <tr className="admin-table-row" >
                                ...
                                <td><span className='text-dark fw-bold'>Shruuti Mam</span> <br /><span style={{ fontSize: '12px', color: 'grey' }}>info@softnio.com</span> </td>
                                <td>02/08/2021	 </td>
                    ...
                    <Modal.Title>
                        <div className='d-flex align-items-center gap-3 mb-3'>
                            {/* <img
                                ...
                                alt=""
                            /> */}
                            <h4 className='fw-bold ' style={{ color: 'rgb(32, 139, 140)' }}>Edit Wastage Return</h4>
                        </div>
                ...
                <Modal.Body>
                    ...
                    <div className='row '>
                        ...
                        <div className="col-lg-6">
                            ...
                            <FloatingLabel className='mb-3' style={{ width: '350px' }} controlId="floatingEmail" label="Seller">
                    ...
                    <div className='row mb-3'>
                        ...
                        <div className="col-lg-6">
                            ...
                            <Form.Select style={{ width: '350px' }} aria-label="Default select example">
                                ...
                                <option value="1" >Wrong Medicine</option>
