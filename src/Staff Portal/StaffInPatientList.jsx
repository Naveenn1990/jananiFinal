...
export const StaffInPatientList = () => {
    ...
    return (
        <div>
            <h4 style={{ backgroundColor: '#dae1f3' }} className='p-4 fw-bold mb-4'>In Patient List</h4>
            ...
            <Container>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-8  d-flex gap-2">
                        ...
                        <FontAwesomeIcon icon={faPlus} /> Add In Patinet
                        </Button>
