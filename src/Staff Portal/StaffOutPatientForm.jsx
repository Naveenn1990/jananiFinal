...
export const StaffOutPatientForm = () => {
    return (
        <div>

            <h4 className='p-4 mb-4 fw-bold text-center' style={{ backgroundColor: '#dae1f3' }} > Out Patinet Admission</h4>
            ...
            <Container>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4">
                        <InputGroup className="mb-3">
                            <InputGroup.Text id="basic-addon1" style={{ borderColor: '#0000006e', color: '#000', fontWeight: 'bold' }}>Vch No</InputGroup.Text>
                            <Form.Control
                                type='number'
                                placeholder="Number"
                                aria-describedby="basic-addon1"
