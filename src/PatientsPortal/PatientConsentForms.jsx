                  ...
                  >
                    ...
                    >
                      ...
                      <p style={{ fontSize: "18px" }}>
                        ...
                        of myself/ my relative and have full faith in the staff
                        of this hospital/ Medical Establishment. I have been
                        explained that admitted Patients and Patients required
                        emergency care take priority of the Doctor. I fully
                      ...
                      <p style={{ fontSize: "18px" }}>
                        ...
                        rendered to me/ relative during the illness regardies of
                        the end result of the illness. I promise not to
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  >
                                    ...
                                    (Including Room Rent, nursing Charges, Duty
                                    Doctor Charges, Monitoring, charges, Primary
                                    Consultant Charges).
                                  </td>
                                  <td
                                    style={{
...
<tr>
                          ...
                          <p style={{ fontSize: "18px" }}>
                            ...
                            >
                              ...
                              <tbody>
                                {item?.InvestigationChargeList?.map((item4)=>{
                                  return(
                                    <tr>
                                    <td
                                      style={{
                          ...
                          <p style={{ fontSize: "18px" }}>
                            ...
                            consultations, ventilator and oxygen, Synringe pump,
                            Patient transport and usages of any other
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      >
                        Patient Name:{" "}
                        <span style={{ fontWeight: "bold" }}>{item?.patientname}</span>{" "}
                      </td>
                      <td
                        style={{ width: "33%", border: "1.5px  solid #20958C" }}
                      >
                    ...
                    <tr>
                      <td
                        style={{ width: "33%", border: "1.5px  solid #20958C" }}
                      >
                        OP No: <span style={{ fontWeight: "bold" }}>12ER3D</span>{" "}
                      </td>
                      <td
                        style={{ width: "33%", border: "1.5px  solid #20958C" }}
                      >
                        IP No: <span style={{ fontWeight: "bold" }}>{user?.PatientId}</span>{" "}
                      </td>
                      <td
                        style={{ width: "33%", border: "1.5px  solid #20958C" }}
                      >
                        Sex: <span style={{ fontWeight: "bold" }}>{user?.Gender}</span>{" "}
                      </td>
                    </tr>  
                    <tr>
                      <td colSpan={3} style={{ border: "1.5px  solid #20958C" }}>
                        <p>
                          ...
                          <span style={{ fontWeight: "bold" }}>{item?.ConDoctorName} </span> and{" "}
                          Dr. {"  "}{" "}
                          <span style={{ fontWeight: "bold" }}>{item?.ConDoctorName2}</span>
                          <br />
                          <br />
                          Medical Condition/Diagnosis:{" "}
                          <span style={{ fontWeight: "bold" }}>{item?.Diagnosis}</span> <br />
                          <br />
                          Proposed operatve Procedure:{" "}
                          <span style={{ fontWeight: "bold" }}>{item?.OperativeProce}</span> <br />
                          <br />
                          I/We, (the relatives/legal guardian of) Mr./Mrs{" "}
                          <span style={{ fontWeight: "bold" }}>{item?.RealivesName}</span> who is
                          admitted on{" "}
                          <span style={{ fontWeight: "bold" }}>
...
<div
              ...
              >
                <tr>
                  ...
                  <td style={{ width: "33%", border: "1.5px  solid #20958C" }}>
                    Date: <span style={{ fontWeight: "bold" }}> {moment(user?.createdAt).format("DD-MM-YYYY")}</span>{" "}
                  </td>
                  <td style={{ width: "33%", border: "1.5px  solid #20958C" }}>
                    Age: <span style={{ fontWeight: "bold" }}>{ageOutput}</span>
                  </td>
                </tr>
                <tr>
                  <td style={{ width: "33%", border: "1.5px  solid #20958C" }}>
                    OP No: <span style={{ fontWeight: "bold" }}>1DJL2</span>{" "}
                  </td>
                  <td style={{ width: "33%", border: "1.5px  solid #20958C" }}>
                    IP No: <span style={{ fontWeight: "bold" }}>{user?.PatientId}</span>{" "}
                  </td>
                ...
                <tr>
                  <td colSpan={3} style={{ border: "1.5px  solid #20958C" }}>
                    ...
                    <span style={{ fontWeight: "bold" }}>{item?.OperativeProce}</span>{" "}
                  </td>
                </tr>
                <tr>
                  <td colSpan={3} style={{ border: "1.5px  solid #20958C" }}>
                ...
                <tr>
                  <td colSpan={3} style={{ border: "1.5px  solid #20958C" }}>
                    <p>
                      I, <span style={{ fontWeight: "bold" }}>{item?.patientname}</span>{" "}
                      (Patient Name), give my full consent out of my own free
                      will to undergo the following surgery / procedure{" "}
                      <span style={{ fontWeight: "bold" }}>{item?.NameOfSurgery}</span> at Janani
