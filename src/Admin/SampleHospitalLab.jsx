...
export default function SampleHospitalLab() {
  ...
  //   const [sampleCollectionDateTime, setsampleCollectionDateTime] = useState("");
  const addlabSample = async () => {
    try {
      const config = {
        url: "/addlabSample",
        method: "put",
    ...
    <div>
      <div style={{ padding: "1%" }}>
              ...
              {AllTestList?.map((item, i) => {
                return (
                  <tr style={{ fontSize: "15px", textAlign: "center" }}>
                    ...
                    <td>
                      {item?.Labtests?.length ===
                      item?.Labtests?.filter((val) => val.sampleName)
                        ?.length ? (
                        <b style={{ color: "green" }}>Sample Added</b>
                    ...
                    <td>
                      {item?.paymentStatus === "PAID" ? (
                        ...
                        <b style={{ color: "red" }}>Sample are not stored</b>
                      )}
                    </td>
                  </tr>
                );
        ...
        <Modal show={show3} onHide={handleClose3} size="lg">
          <Modal.Header closeButton>
            <Modal.Title>Lab Sample</Modal.Title>
          </Modal.Header>
          <Modal.Body>
        ...
        <Modal show={show5} onHide={handleClose5} size="lg">
          <Modal.Header closeButton>
            <Modal.Title> Add Lab Sample</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <div>
              <div style={{ overflow: "hidden", overflowX: "scroll" }}>
                    ...
                    <Table bordered>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <Button onClick={addlabSample}>Submit</Button>{" "}
                          </td>
                        </tr>
                      </tbody>
                    </Table>
