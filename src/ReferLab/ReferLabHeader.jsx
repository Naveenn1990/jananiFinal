          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              ...
              <div className="dropdown">
                ...
                <button className="dropbtn navigation-all fs-6" >Ganesh
                  <img style={{ width: '40px ', marginLeft: '10px', height: '40px', borderRadius: '50%' }} src="./img/admin-doctors-list-3.jpg" alt="img" />
                </button>
