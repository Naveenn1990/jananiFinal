...
export const ReferSettings = () => {
    ...
    return (
        <div>
             <h4 style={{ backgroundColor: '#dae1f3' }} className='p-4 fw-bold'>Settings</h4>
            <Container className=''>
                ...
                <h4 className=' fw-bold mb-4'>Security Settings</h4>
                    ...
                    <FloatingLabel className='mb-4' style={{ width: '600px' }} controlId="floatingEmail" label="Username">
                        <Form.Control type="text" placeholder="Username" />
                    </FloatingLabel>

                  
                    <FloatingLabel className='mb-4' style={{ width: '600px' }} controlId="floatingPassword" label="Password">
                    ...
                    <FloatingLabel className='mb-4' style={{ width: '600px' }} controlId="floatingPassword" label="Confirm Password">
                    ...
                    <div>
                        <Button className=' mb-4' style={{ width: "20%", height: '40px', fontSize: '16px' , backgroundColor:'rgb(32 139 140)' }} onClick={() => { navigate('#') }}>Save</Button>
                    </div>
                ...
                <h4 className=' mb-4 fw-bold'>Account Settings</h4>
                    ...
                    <FloatingLabel className='mb-5' style={{ width: '600px' }} controlId="floatingEmail" label="Email">
                    ...
                    <div className='d-flex gap-2 mb-5'>
                        ...
                        <FloatingLabel style={{ width: '290px' }} controlId="floatingCity" label="City">
                    ...
                    <FloatingLabel className='mb-5' style={{ width: '600px' }} controlId="floatingStreetAddress" label="Street Address">
                        <Form.Control type="text" placeholder="Street Address" />
                    </FloatingLabel>

                    <div>
                        <Button className=' mb-4' style={{ width: "20%", height: '40px', fontSize: '16px' , backgroundColor:'rgb(32 139 140)' }} onClick={() => { navigate('#') }}>Save Changes</Button>
                    </div>
