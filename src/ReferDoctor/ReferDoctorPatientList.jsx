            ...
            <Container>
                <div className="row">
                    ...
                    <div className="col-lg-8  d-flex gap-2">
                        ...
                        <Button className='green-btn-9' onClick={() => navigate('/referaddpatient')}>
                        ...
                        <tbody >
                            ...
                            {RefPatientList?.map((item)=>{
                                return(
                                    ...
                                    <td className=" me-2">
                                        <a href="#" className='fw-bold'> {item?.Firstname}</a>
                                    </td>
                                    ...
                                    <td>
                                        <div className="Diseases-btn" style={{ color: 'green', border: '1px solid green' }}>{item?.InjuryCondition}</div>
                                    </td>
