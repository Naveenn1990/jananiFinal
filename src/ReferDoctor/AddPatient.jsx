                ...
                <Container className=''>
                    ...
                    <Form style={{ marginLeft: "100px", marginTop: '50px' }}   >
                        ...
                        <div className="d-flex gap-4 mb-5">
                            ...
                            <Form.Select style={{ width: '400px' }} aria-label="Default select example" onChange={(e)=>setgender(e.target.value)}>
                        ...
                        <div className="d-flex gap-4 mb-5">
                            ...
                            <FloatingLabel style={{ width: '400px' }} controlId="floatingEmail" label="Blood Presure">
                                <Form.Control type="text" placeholder="Blood Presure" onChange={(e)=>setBloodPressure(e.target.value)}/>
                            </FloatingLabel>
                        ...
                        <div className="d-flex gap-4 mb-5">
                            ...
                            <Form.Select style={{ width: '400px' }} aria-label="Default select example" onChange={(e)=>setMaritalStatus(e.target.value)}>
                                <option>Marital Status </option>
                                <option value="Single">Single</option>
                                <option value="Married">Married</option>
                            </Form.Select>

                            <Form.Select style={{ width: '400px' }} aria-label="Default select example" onChange={(e)=>setbloodgroup(e.target.value)}>
                        ...
                        <div className='mb-5' >
                            <FloatingLabel style={{ width: '400px' }} controlId="floatingEmail" label="Sugar Level">
                                <Form.Control type="text" placeholder="Sugar Level" onChange={(e)=>setSugarlevel(e.target.value)}/>
                            </FloatingLabel>
                        </div>

                        <div className='mb-5' >
                            {/* <label >Comments</label> */}
                            <textarea class="form-control" placeholder="Address" id="floatingTextarea2" style={{ width: '820px', height: "100px" }} onChange={(e)=>setAddress(e.target.value)}></textarea>
                        </div>
                        ...
                        <FloatingLabel className='mb-5' label="Injury/Contion">
                            <Form.Control style={{ width: '820px', height: '100px' }} type="text" placeholder="Injury/Contion" onChange={(e)=>setInjuryCondition(e.target.value)}/>
                        </FloatingLabel>
                        ...
                        <div className='d-flex gap-3 mb-4 mt-4'>
                         ...
                         <Button  style={{ width: "10%", height: '40px', fontSize: '16px', backgroundColor: '#FE2E2E' }} onClick={(e) => { AddRefPatient(e) }}>Cancel</Button>
