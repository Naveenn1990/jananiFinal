...
export default function VendorAdminInvoice() {
  let vendorDetails = sessionStorage.getItem("VendorDetails");
  ...
  useEffect(() => {
    vendorDetails = JSON.parse(JSON.stringify(vendorDetails));
    if (!vendorDetails) {
      return alert("Vendor login needed!");
    }
  }, [vendorDetails]);

  console.log("KFKFKvendorDetails: ", JSON.parse(vendorDetails));
  return (
        ...
        >
          <div className="d-flex justify-content-between ">
            <div className="mb-5">
              ...
              <span>
                {JSON.parse(vendorDetails)?.fname}{" "}
                {JSON.parse(vendorDetails)?.lname}
              </span>
              <br />
              <span>{JSON.parse(vendorDetails)?.vendorId}</span>
              <br />
              <span>{JSON.parse(vendorDetails)?.phone}</span>
              <br />
              <br />
              <span>
