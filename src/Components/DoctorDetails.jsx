        ...
        <div>
          <div className="row mb-2 align-items-center">
            ...
            <div className="col-md-6 col-lg-5 mb-4">
              ...
              {/* <a href="/schedules"> */}
              <Link to="/schedules" state={{ DoctorId: item?._id }}>
                <Button className="red-btn-8"></Button>{" "}
              </Link>
              {/* </a> */}
            </div>
          ...
          <div>
            ...
            <Slider {...settings}>
              {Doctors?.filter((dc) => dc._id !== item?._id)?.map((Doc, i) => (
                <>
                  <div key={i}>
                    <Card
                      className="m-auto"
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          src={`http://localhost:8521/Doctor/${Doc?.ProfileImg}`}
                          alt="Doctor-img"
                        />
                      </Link>
                      <Card.Body>
                        ...
                        <p className="fw-bold">"{Doc?.Department}"</p>
                        <Card.Text>
                          <div style={{ textAlign: "justify" }}>
                            {Doc?.Description?.slice(0, 96)}
                          </div>
                        </Card.Text>
                      </Card.Body>
                    </Card>
