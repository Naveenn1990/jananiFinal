    ...
    return (
        <div>
            <div className='head-back-img' style={{ backgroundImage: "url(./img/all-department-img.jpg)", width: "100%", height: "150px", backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: "cover" }}>
                <Container>
                    <h1 data-aos='fade-right' data-aos-duration='3000' className='text-dark pt-5 fw-light back-img-head'>Blog</h1>
                </Container>
            </div>
            ...
            <Container className='mt-5'>
                ...
                <h4 className='text-center fw-bold mb-4' style={{ color: "rgb(32 139 140)" }}>{item?.BlogTag}</h4>
                <div >

                    <div data-aos='fade-up' className="row mt-4 ">
                        <div className='col-md-6 col-lg-8 mb-3' style={{ fontSize: "14px" }}>
                            <p style={{ textAlign: 'justify' }}>{parse(`<div>${item?.BlogDescription}</div>`)}</p>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4 d-flex justify-content-center mb-3 ">
                            <div>
                                ...
                                <img className='img-fluid mb-2' src={`http://localhost:8521/Blog/${item?.BlogImg}`} alt="" style={{ width: '300px', height: '315px', imageRendering:'pixelated' }} />
                    ...
                    <div >
                        <h3 className='fw-bold mb-2 text-center' style={{ color: "rgb(32 139 140)" }}> Related Blogs </h3>
                        <Slider className='slick-slidder'  {...settings}>
                            {BlogDetails?.map((item) => {
                                return (<>
                                    <div  >
                                        <Card data-aos='fade-up' data-aos-duration='1500' className='m-auto' style={{ width: '15rem', minHeight: '250px' }}>
                                            <Link onClick={window.scrollTo(0, 0)} state={{ item: item }} to="/eventBlog"><img style={{ width: "100%", height: "150px" }} src={`http://localhost:8521/Blog/${item?.BlogImg}`} alt="Doctor-img" /></Link >
                                            <Card.Body className='p-3'>
                                                <Card.Text> <Link onClick={window.scrollTo(0, 0)} state={{ item: item }} className='fw-semibold' style={{ textDecoration: "none", color: "rgb(32 139 140)" }} to="/eventBlog">{item?.BlogTag}</Link ></Card.Text>
