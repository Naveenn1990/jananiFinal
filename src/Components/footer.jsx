...
import { AiOutlineMail, AiOutlineAppstoreAdd, AiOutlineWhatsApp, AiOutlineArrowRight } from "react-icons/ai";
                    ...
                    <MDBContainer className='p-4'>
                        <MDBRow className='gap-3'>
                            <MDBCol lg='6' md='12' className='mb-2 text-start' >
                                <h5 className='text-uppercase fs-2 fw-bold' >India,s largest and highest rated hospital network</h5>

                                <p>
                                    Lorem ipsum dolor sit amet consectetur, adipisicing <br /> elit. Iste atque ea quis molestias.
                                </p>
                            </MDBCol>

                            <MDBCol lg='2' md='6' className='mb-2' style={{ textAlign: 'justify' }}>
                                <div >
                                    ...
                                    <ul className='list-unstyled ' >
                                        ...
                                        <li>
                                            <a href='/eventBlog' className='text-white'>
                            ...
                            <MDBCol lg='3' md='6' className='mb-2 mb-md-0' style={{ textAlign: 'justify' }}>
                                <h5 className='text-uppercase mb-4 fw-bold'>Contact</h5>

                                <ul className='list-unstyled'>
                                    <li className='mb-2'>
                                        <a href='/contact' className='text-white'>
                                            <AiOutlineMail style={{ fontSize: '25px', marginRight: '10px' }} /> example@example.com
                                        </a>
                                    </li>

                                    <li className='mb-2'>
                                        <a href='/contact' className='text-white'>
                                            <CiLocationOn style={{ fontSize: '25px', marginRight: '10px' }} />
                                            Singapoor layout <br />
                                            pincode 110011 Lorem, ipsum.
                                        </a>
                                    </li>
                                    ...
                                    <li className='mb-2'>
                                        <a href='/contact' className='text-white'>
                                            <AiOutlineWhatsApp style={{ fontSize: '25px', marginRight: '10px' }} /> Contacts number
                                        </a>
                                    </li>
                                </ul>
                            </MDBCol>
