...
import { Button, Card, Container, FloatingLabel, Form, FormLabel, Modal } from 'react-bootstrap'
        ...
        <div>
                    ...
                    <Card
                        ...
                        <Card.Body>
                            ...
                            <div className='d-flex gap-3'>
                                <Button onClick={hadleShow} className='all-bg-green'>Edit Profile</Button>
                                <Button onClick={passwordShow} className='all-bg-green'>Change Password</Button>
                            </div>
                        </Card.Body>
                    </Card>
                </div>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    ...
                    <FloatingLabel className='mb-3' style={{ width: '100%' }} label="Name">
                    ...
                    <FloatingLabel className='mb-3' style={{ width: '100%' }} label="Number">
            ...
            <Modal show={show1} onHide={passwordClose}>
                ...
                <Modal.Body>
                    ...
                    <FloatingLabel className='mb-3' style={{ width: '100%' }} label="Enter Your Passoword">
                        <Form.Control type="password" placeholder="Enter Your Passoword" />
                    </FloatingLabel>

                    <FormLabel className='fw-bold text-dark'>Confirm New Password*</FormLabel>
                    <FloatingLabel className='mb-3' style={{ width: '100%' }} controlId="floatingEmail" label="Enter Your Passoword">
                        <Form.Control type="password" placeholder="Enter Your Passoword" />
                    </FloatingLabel>
